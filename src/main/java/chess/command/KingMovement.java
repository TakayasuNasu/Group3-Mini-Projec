...
public class KingMovement implements Movement{
  ...
  public ArrayList<Integer> where() {
    ...
    if (this.valid.canMove(pos1)) positions.add(pos1);
    if (this.valid.canMove(pos2)) positions.add(pos2);
    if (this.valid.canMove(pos3)) positions.add(pos3);
    if (this.valid.canMove(pos4)) positions.add(pos4);
    if (this.valid.canMove(pos5)) positions.add(pos5);
    if (this.valid.canMove(pos6)) positions.add(pos6);
    if (this.valid.canMove(pos7)) positions.add(pos7);
    if (this.valid.canMove(pos8)) positions.add(pos8);
